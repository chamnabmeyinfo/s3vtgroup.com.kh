<?php
/**
 * Feature All Products in Category API
...
try {
    ...
    // Update all products in this category (and subcategories) to featured
    $sql = "UPDATE products SET is_featured = 1 WHERE category_id IN (" . implode(',', $placeholders) . ")";
    db()->query($sql, $params);
    ...
    $response['message'] = "Successfully featured {$count} product(s) in '{$categoryName}' category.";
